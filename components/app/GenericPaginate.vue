<template>
    <div class="flex items-center justify-between px-4 py-3 bg-white border-t border-gray-200 sm:px-6">
        <nav class="flex items-center justify-between" aria-label="Pagination">
            <slot name="prev">
                <button
                    class="relative inline-flex items-center mr-1 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 cursor-pointer rounded-md shadow-sm hover:bg-gray-50"
